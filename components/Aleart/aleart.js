    ...
    return (
        ...
        <div id="alert-3" className="flex mt-8 bg-green-100 rounded-lg p-4 mb-4 dark:bg-green-200"
            ...
            <div className="ml-3 text-sm font-medium text-green-700 dark:text-green-800">
                Done !<a href="#" className="font-semibold hover:text-green-800 underline dark:hover:text-green-900">
                Successful.</a>
            </div>
            <button type="button"
...
export function AleartError ( props ) {
    ...
    return (
        ...
        <div id="alert-3" className="flex mt-8 bg-yellow-100 rounded-lg p-4 mb-4 dark:bg-yellow-200"
             role="alert">
            <svg className="w-5 h-5 text-yellow-700 flex-shrink-0 dark:text-yellow-800"
                 fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd"
                      d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                      clipRule="evenodd"></path>
            ...
            <div className="ml-3 text-sm font-medium text-yellow-700 dark:text-yellow-800">
                Error !<a href="#" className="font-semibold hover:text-yellow-800 underline dark:hover:text-yellow-900">
                { props.error }.</a>
            </div>
            <button type="button"
